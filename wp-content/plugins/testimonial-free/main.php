    ...
    function sp_tf_options_framwrork()
    {
        ...
        <div class="wrap about-wrap">
            ...
            <p>We've added many extra features in our <a href="https://shapedplugin.com/plugin/testimonial-pro/">Premium
                    Version</a> of this
                plugin. Let see some amazing features. <a href="https://shapedplugin.com/plugin/testimonial-pro/">Buy
                    Premium Version Now.</a></p>
            ...
            <div class="feature-section two-col">
                ...
                <div class="col">
                    <ul>
                        ...
                        <li><span class="dashicons dashicons-yes"></span> Notification e-mail for Testimonial submission
                            to Admin
                        </li>
                        <li><span class="dashicons dashicons-yes"></span> Testimonial pending for approval by Admin to
                            show in frontend
                        </li>
                        <li><span class="dashicons dashicons-yes"></span> Front-end submission form fields show/hide
                            options
                        </li>
                        <li><span class="dashicons dashicons-yes"></span> 100% Responsive & Mobile Friendly</li>
                        <li><span class="dashicons dashicons-yes"></span> Very Light weight, clean & beautiful design
                        </li>
                        ...
                        <li><span class="dashicons dashicons-yes"></span> Testimonials Order by (Date, Title, modified,
                            Author, Random)
                        </li>
                        ...
                        <li><span class="dashicons dashicons-yes"></span> Set different style client images (Circle,
                            Round, Square, Border)
                        </li>
                        <li><span class="dashicons dashicons-yes"></span> Show maximum number of testimonials displayed
                            in devices
                        </li>
                    </ul>
                </div>
