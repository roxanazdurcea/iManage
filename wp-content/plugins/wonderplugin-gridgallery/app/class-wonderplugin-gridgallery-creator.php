					...
					<div class="wonderplugin-gridgallery-options-tabs" id="wonderplugin-gridgallery-options-tabs">
						...
						<ul class="wonderplugin-tabs-horizontal" id="wonderplugin-lightbox-panels">
							...
							<tr valign="top">
								...
								<p><label for="wonderplugin-gridgallery-lightboxshowfacebook"><input name="wonderplugin-gridgallery-lightboxshowfacebook" type="checkbox" id="wonderplugin-gridgallery-lightboxshowfacebook" /> Show Facebook button</label>
